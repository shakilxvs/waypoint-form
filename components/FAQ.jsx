...
const FAQS = [
  ...
  },
  {
    ...
    a: "Foundation Visits (exam + X-rays) take roughly 60-90 minutes. Routine cleanings are around 45-60 minutes. More complex procedures may take longer — we will give you a clear time estimate during your confirmation call.",
  },
  {
  ...
  },
  {
    ...
    a: "Absolutely. Caregivers and family members are welcome to submit a request on behalf of a loved one. Just include their name and address in the form and mention in your notes that you are arranging care for someone else.",
  },
  {
